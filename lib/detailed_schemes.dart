  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[
          IconButton(
            padding: const EdgeInsets.fromLTRB(0.0, 5.0, 72.0, 2.0),
            icon: const Icon(
              Icons.female,
              size: 35,
            ),
          ...
          Column(
            children: <Widget>[
              Container(
                  ...
                  width: 380,
                  height: 250,
                  margin: const EdgeInsets.fromLTRB(5.0, 25.0, 5.0, 5.0),
                        ...
                        children: [
                          Row(
                            children: [
                              Container(
                                  padding:
                                      const EdgeInsets.fromLTRB(20, 10.0, 0.0, 1.0),
                                  child: const Text(
                                    "Read More ",
                                    style: TextStyle(
                          ...
                          Row(
                            children: [
                              Container(
                                  padding:
                                      const EdgeInsets.fromLTRB(60, 10.0, 0.0, 1.0),
                                  child: const Text(
                                    "Apply Now ",
                                    style: TextStyle(
                                        fontSize: 18, color: Colors.blue),
